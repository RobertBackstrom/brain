...
## 2026-09-07 - Sizing an unreleased multiplayer indie with no wishlist figure (Disposable Corps / LUG)

- **Followers are readable when wishlists are not.** `https://steamcommunity.com/games/<appid>/memberslistxml/?xml=1` returns `<memberCount>` = store followers for any app, no auth, no bot wall (SteamDB is 403 from the VPS, raijin.gg and steamcharts.com 403/500 on small apps). GDCo's follower-to-wishlist multiplier is 7x to 20x, median 12x, lower (7,5x to 9,5x) for deep PC titles. A page that grew on a free demo and playtests sits at the bottom: Striden had 12 000 wishlists against 6 343 followers (about 2x). State the band, then ask the publisher for the real number; it halves the analysis width. [dsc, 2026-09-07]
- **A "units to recoup" figure in a plan must be checked against realised net, not headline x 0,70.** The DC plan said 7 500 units for 750 000 SEK, which is 14,99 USD x 0,70 x 9,56 = 100 SEK/unit. Realised net for a China-weighted 14,99 title is 43 to 58 SEK after regional tier (CNY at ~50 percent of USD), blended discount, VAT, refunds and Steam's cut, so the crossing is ~14 400 units, and ~50 000 if recoup is pro rata with the investors' cash. Always ask which share of net the recoup draws from; the plan had not written it down. [dsc, 2026-09-07]
- **Demo reviews per language are a free region-mix instrument.** `appreviews?json=1&language=<lang>&num_per_page=0` per language: DC's demo was 53 of 77 in Chinese, which set the China share (55 to 65 percent) and hence the price haircut. [dsc, 2026-09-07]
- **Launch peak CCU runs at 8 to 10 percent of first-week units for small multiplayer shooters** (Striden 285, Last Flag 558, Beyond The Wire 1 228 in EA month), and loses 70 to 80 percent inside four weeks (Last Flag, Trench Tales 107 to 1, Striden 285 to 3). Use it to turn a units band into a "is the browser empty by week five" answer. Comparables at this budget that survived (Easy Red 2 1 106 live at 8,99, Ravenfield, Operation: Harsh Doorstop) all play against bots; Zero Hour and Due Process, both good 5v5 with real publishers, are at 70 and 1 live. R1 independently put the 5v5 matchmaking floor at 500 global CCU and dead-at-six-months at 70 to 85 percent. [dsc, 2026-09-07]
- **R1's comparable tables are stale; its affinity data is the part to use.** On the same day it gave Easy Red 2 "4 500+" reviews (API: 14 941), Beyond The Wire at 34,99 USD (store: 9,99) and Holdfast a 6 243 peak (steamcharts 3 419). Pull the numbers from `market-intel.js`, take over-index and overlap from R1. Playwright for the driver lives at `/home/assistant/projects/assistant/node_modules/playwright`, not the `_npx/9833c...` path in the memory note. [dsc, 2026-09-07]
