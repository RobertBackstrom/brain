...
**Armoured Dudes** - developer, the actual client. **Two founders plus a few contractors (Robert, 2026-09-07, correcting the earlier "two people" reading). Sustained delays, and real concern on LUG's side about delivery.** Paul codes, Hammer carries vision and game design. The earlier four-person team (main programmer, junior programmer, designer/CEO/producer, artist) is gone; Anthony's internal note is that it was junior and its UI/UX was bad. Never put that assessment in writing outside AP. They are now inside the budget at 30 000 SEK a month for both, a number Anthony set.
