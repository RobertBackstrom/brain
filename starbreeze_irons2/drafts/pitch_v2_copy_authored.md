# Project Irons 2 — Pitch v2 copy, round 2, voice-passed (The Author, 2026-09-01)
...
**Full ownership.** We take end-to-end ownership of the work required to deliver against the
project's creative and technical goals.
...
2. **Manual scripting load from the port.** Irons 1 showed that recreating levels in the PUBG
   engine is scripting-heavy. The level design and tech design roles are staffed early and held
   through Beta.
