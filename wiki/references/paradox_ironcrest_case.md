...
> **Wiki mirror.** Canonical source: `paradox_ironcrest_case/ironcrest_business_case_working_doc.md` (project folder, now RAG-indexed under source=project). Companion insight: skill [[paradox_publishing_model]]. Mirrored here 2026-06-22 per Robert's request.
