...
|------|------|-------|---------|
| 2026-04-23 | Project scaffold created (renamed from Gangs of Forsaken) | VPS + config.json + MEMORY.md | — |
| 2026-05-08 | Logo brief v0 + refs walkthrough (24 refs, 16 keep / 8 drop / 2 v2-bookmark) | art/logo/{refs_log.md, brief.md} | Pending Robert review |
| 2026-05-08 | AI concept gen: Lane A (Flux.dev × 12) + Lane B (fast-SDXL × 12) via fal.ai REST | art/logo/concepts/{fal-flux,fal-sdxl}/ + contact_*.png | Cost ~$0.36; pending Robert curation |
| 2026-05-09 | Refs restricted to 2 anchors (roc_logo02 + kg_metallic_mockup) per Robert | art/logo/refs/{approved/, refs_log.md} | Active set narrowed; archive preserved |
| 2026-05-09 | SD3.5-large probe: merged 80s-tabletop + heavy-metal prompt × 4 seeds @ 1536×1024 | art/logo/concepts/sd35-large/ + contact_sheet.png | Cost ~$0.16; seed7777 + seed9001 strong, 4242 partial, 1337 broken |
| 2026-05-21 | DevGAMM Gdańsk Game Showcase booth declined — reply to Valeria Reznikova; Baltic Showcase on Steam kept | Email sent (thread 19dafcece9d1b6a2) | Sent |
...
| 2026-09-08 | 3D Character Artist role as a Google Doc (public ad + shortlist version + open decisions) | `drafts/3d_character_artist_role.html` + Drive doc `1pMw-QCl9SdLcGEl2F2J4UFOniRkzMAiTcbIz5N2yWts` | Draft in Roberts own Drive, NOT in the shared Ark Island folder |
